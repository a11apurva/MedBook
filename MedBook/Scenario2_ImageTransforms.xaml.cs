...
namespace UI_try_1
{
    ...
    /// On Windows Phone, the page implements IFileOpenPickerContinuable/IFileSavePickerContinuable
    /// to support Windows Phone-style continuable file pickers. This interface is invoked when
    ...
    public sealed partial class ImagingTransforms :
        Page,
        IFileOpenPickerContinuable,
        IFileSavePickerContinuable
#else
    public sealed partial class ImagingTransforms : Page
#endif
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            this.SizeChanged += ImagingTransforms_SizeChanged;
        ...
        /// <summary>
        /// Changes the sample page layout depending on the available screen width.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void ImagingTransforms_SizeChanged(object sender, SizeChangedEventArgs e)
        {
